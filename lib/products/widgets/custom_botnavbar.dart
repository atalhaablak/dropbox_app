        ...
        Container(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                IconButton(onPressed: () {}, icon: Icon(Icons.home, size: 36)),
                IconButton(onPressed: () {}, icon: Icon(Icons.file_open, size: 36)),
                IconButton(onPressed: () {}, icon: Icon(Icons.star, size: 36)),
                IconButton(onPressed: () {}, icon: Icon(Icons.person, size: 36)),
              ],
            ),
          ),
        )
